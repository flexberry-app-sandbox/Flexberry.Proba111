...
namespace IIS.Proba11
{
    ...
    public class РегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba11.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba11.Сотрудники fСотрудники;
        
        private IIS.Proba11.Организация fОрганизация;
        
        private IIS.Proba11.ПланирСобес fПланирСобес;
        ...
        public virtual IIS.Proba11.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba11.ИтогСобес result = this.fИтогСобес;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Proba11.Организация Организация
        {
            get
            {
                ...
                IIS.Proba11.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "ПланирСобес"})]
        [NotNull()]
        public virtual IIS.Proba11.ПланирСобес ПланирСобес
        {
            get
            {
                ...
                IIS.Proba11.ПланирСобес result = this.fПланирСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba11.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba11.Сотрудники result = this.fСотрудники;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультE", typeof(IIS.Proba11.РегРезульт));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегРезультL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультL", typeof(IIS.Proba11.РегРезульт));
                }
            }
        }
    }
