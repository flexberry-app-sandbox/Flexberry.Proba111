...
namespace IIS.Proba11
{
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba11.DetailArrayOfТЧРегистАнкеты fТЧРегистАнкеты;
        ...
        public virtual IIS.Proba11.DetailArrayOfТЧРегистАнкеты ТЧРегистАнкеты
        {
            get
            {
                ...
                {
                    this.fТЧРегистАнкеты = new IIS.Proba11.DetailArrayOfТЧРегистАнкеты(this);
                }
                IIS.Proba11.DetailArrayOfТЧРегистАнкеты result = this.fТЧРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Proba11.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Proba11.РегистАнкеты));
                }
            }
        }
    }
